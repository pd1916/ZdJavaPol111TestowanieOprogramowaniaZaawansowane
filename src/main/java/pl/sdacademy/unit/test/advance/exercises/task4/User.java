...
public class User {
    ...
    public boolean valid() {
        if (!this.validName()) {
            throw new IllegalArgumentException("bad name"); // możecie oczywiście dodać swoje własne wyjątki
        }
    ...
    /*
    poniższe walidatory to tylko przykładami, każdy może napisać duże lepsze, bardziej rozbudowane
    nie zapomnijcie ich tylko wtedy porządnie przetestować ;)
     */
